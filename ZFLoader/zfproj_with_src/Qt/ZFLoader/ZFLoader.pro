...
$$ZFAddLib($${ZF_ROOT_PATH}/ZF, 0, ZFUIExt)
...
$$ZFAddLib($${ZF_ROOT_PATH}/ZF, 1, ZFLua_impl)
$$ZFAddLib($${ZF_ROOT_PATH}/ZF, 1, ZFUIWebKit_impl)
$$ZFAddLib($${ZF_ROOT_PATH}/ZF, 1, ZFNet_impl)
