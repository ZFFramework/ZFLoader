...
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/zfgensrc_ZFLoader.mm" "${iOS_SRCROOT}/../../../zfsrc"
...
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFUIExt/zfgensrc_ZFUIExt.mm" "$ZF_ROOT_PATH/ZF/ZFUIExt/zfsrc"
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFLua/zfgensrc_ZFLua.mm" "$ZF_ROOT_PATH/ZF/ZFLua/zfsrc"
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFUIWebKit/zfgensrc_ZFUIWebKit.mm" "$ZF_ROOT_PATH/ZF/ZFUIWebKit/zfsrc"
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFNet/zfgensrc_ZFNet.mm" "$ZF_ROOT_PATH/ZF/ZFNet/zfsrc"
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFAppUtil/zfgensrc_ZFAppUtil.mm" "$ZF_ROOT_PATH/ZF/ZFAppUtil/zfsrc"
...
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFLua_impl/zfgensrc_ZFLua_impl.mm" "$ZF_ROOT_PATH/ZF/ZFLua_impl/zfsrc"
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFUIWebKit_impl/zfgensrc_ZFUIWebKit_impl.mm" "$ZF_ROOT_PATH/ZF/ZFUIWebKit_impl/zfsrc"
sh "$ZF_ROOT_PATH/tools/common/unity_build.sh" "${COMPILE_DST_PATH}/ZFNet_impl/zfgensrc_ZFNet_impl.mm" "$ZF_ROOT_PATH/ZF/ZFNet_impl/zfsrc"
